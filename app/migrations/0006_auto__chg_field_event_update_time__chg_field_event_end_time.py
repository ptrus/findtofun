...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.update_time'
        db.alter_column(u'app_event', 'update_time', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Event.end_time'
        db.alter_column(u'app_event', 'end_time', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Event.update_time'
        db.alter_column(u'app_event', 'update_time', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 3, 29, 0, 0)))

        # Changing field 'Event.end_time'
        db.alter_column(u'app_event', 'end_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 3, 29, 0, 0)))
