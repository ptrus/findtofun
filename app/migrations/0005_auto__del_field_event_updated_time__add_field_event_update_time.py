...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.update_time'
        db.add_column(u'app_event', 'update_time',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Event.updated_time'
        raise RuntimeError("Cannot reverse this migration. 'Event.updated_time' and its values cannot be restored.")
        # Deleting field 'Event.update_time'
        db.delete_column(u'app_event', 'update_time')
    ...
    models = {
        u'app.event': {
            ...
            'update_time': ('django.db.models.fields.DateField', [], {'blank': 'True'})
        },
        u'app.host': {
